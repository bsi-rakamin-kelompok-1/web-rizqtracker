...
const Topup = () => {
  ...
  const [errors, setErrors] = useState<Partial<typeof formData>>({});
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
          setIsLoading(true);
          const res = await axios.post("https://kelompok1.serverku.org/v1/transactions/topup", formData,
            {
                headers: {
          ...
          <Card className="w-full max-w-md">
            <CardContent className="p-5 space-y-3">
              ...
              <div className="space-y-1 my-6">
                ...
                <Select onValueChange={handleTopupMethodChange} value={formData.topup_method}>
